...
import { TDraggableImageInputProps } from './types';
...
export const DraggableImageInput = <T extends FieldValues>(
  ...
  return (
    ...
    >
        ...
        <div key={index} className="relative w-full">
          ...
          field.value !== undefined ? (
            <div key={index} className="m-2 w-full">
              <div className="relative mx-auto w-full h-32 overflow-hidden rounded-lg shadow-md">
                <Image
      ...
      {field.value === undefined && (
        <div
          className={`flex flex-col items-center w-full bg-[#F5F5F5] dark:bg-transparent rounded-lg hover:text-white ${props.labelStyle}`}
        >
          <IconFile />
