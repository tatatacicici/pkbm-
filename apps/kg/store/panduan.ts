...
export const globalPanduanStateAtom = atom<Array<globalPanduanType>>([
  {
  ...
  {
    title: 'Buku Bagaimana caranya jika saya ingin melakukan diskusi pada dosen',
    href: '/panduan/buku-panduan/panduan-pendaftaran',
  },
  {
...
export const queryGlobalPanduanAtom = atom('');
