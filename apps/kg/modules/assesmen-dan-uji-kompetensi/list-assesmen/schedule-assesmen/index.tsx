...
export default function ScheduleAssesmenModule() {
      ...
      <div className="bg-grey-100">
        <div className="w-full max-w-[1440px] mt-4 mb-12 mx-auto min-h-[80vh] space-y-4 px-8 md:px-14 lg:px-16 2xl:px-0 ">
          <div className="bg-white rounded-md p-8 w-full shadow-sm">
            <h2 className="text-2xl font-bold">Jadwal Assesmen</h2>
          </div>
          <div className="flex gap-4">
            <div className="bg-white shadow-md rounded-lg overflow-hidden relative w-2/5">
              <div className="absolute top-2 left-3 bg-violet-500 text-white px-2 py-1 rounded-lg">
                <p className="text-xs">Assesmen</p>
              </div>
              <Image
              ...
              <div className="p-4 space-y-4">
                <p className="text-xl font-semibold text-black">
                  Kompetensi : Web Front End Programming
                </p>
                <div className="flex items-center gap-2 text-gray-500 text-sm">
                  <IoPersonOutline />
                  <p className="">Rizki Pratama</p>
                </div>
              </div>
            </div>
