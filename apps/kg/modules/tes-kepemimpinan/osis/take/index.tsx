...
import { quizOsisInfoDummyData, quizOsisTakeDummyData } from '../../constant';
...
export const QuizTakeModule = () => {
  ...
  const data = quizOsisTakeDummyData;
  ...
  function createResult() {
    ...
    const totalQuestions = quizOsisInfoDummyData.quiz.total_questions;
    const questionPoint = quizOsisInfoDummyData.quiz.question_point;
    const remainingAttempt = quizOsisInfoDummyData.quiz.remaining_attempts;
