...
import { quizOsisInfoDummyData, TesKepemimpinanBreadcrumb } from '../constant';
...
export const QuizDetailModule = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const storedStatus = localStorage.getItem(
        'selectedAnswers-tes-kepemimpinan-osis'
      );
  ...
  useEffect(() => {
    if (
      quizOsisInfoDummyData.subject.name &&
      quizOsisInfoDummyData.quiz.title
    ) {
      let title = quizOsisInfoDummyData.quiz.title.trim();
      ...
      document.title = `Kuis ${title} - ${quizOsisInfoDummyData.subject.name} | Paket-C Gratis`;
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-2 sm:p-5 mb-3 sm:mb-4">
                ...
                <p className="text-gray-600 text-xs sm:text-sm">
                  Tes kepemimpinan OSIS yang dirancang untuk menggali karakter,
                  visi, dan kemampuan Anda dalam memimpin.
                </p>
              </div>
              ...
              {quizDesc.remaining_attempts > 0 &&
                ...
                <Link
                  ...
                  className="inline-flex items-center text-sky-base hover:opacity-80 font-medium text-xs sm:text-sm transition-all"
                >
