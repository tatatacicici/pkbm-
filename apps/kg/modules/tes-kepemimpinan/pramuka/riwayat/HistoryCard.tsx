...
import { quizOsisInfoDummyData } from '../../constant';
      ...
      <section className="flex flex-col sm:flex-row justify-between items-center lg:gap-x-2 mt-3">
        <div className="flex flex-col w-full h-auto lg:w-28 py-2 lg:py-0 mb-2 lg:mb-0 items-center justify-center">
          <h1 className="text-4xl font-bold">
            {Math.round(dataQuizHistory.score)}
          </h1>
          <p className="text-xs">
            {dataQuizHistory.score >= quizOsisInfoDummyData.quiz.passing_score
              ? 'Lulus'
              : 'Tidak Lulus'}
          </p>
        </div>
        <div className="gap-2 grid grid-cols-1 md:grid-cols-2">
          <DetailCard type="trueAnswer" value={dataQuizHistory.right} />
