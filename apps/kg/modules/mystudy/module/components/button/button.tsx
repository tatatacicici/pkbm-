...
export const ModuleButton: FC<ButtonProps> = ({
  ...
  const sizesClass = {
    ...
    base: `w-full h-[42px] lg:w-[160px] lg:h-[48px] text-[16px] font-medium ${
      WFull && '!lg:w-full'
    }`,
  ...
  const merged = `flex gap-x-2 rounded justify-center items-center hover:opacity-90 disabled:hover:opacity-100
   ${colorClass[color]} ${sizesClass[size]} ${className}`;
