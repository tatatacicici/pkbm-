...
export const PostReportModal: FC<TPostReportProps> = ({
  ...
  //report_type must be one of the following values: SPAM, HATE_SPEECH, VIOLENCE_DANGEROUS_ORGANIZATION, NUDITY_SEXUAL_ACT, ILLEGAL_GOODS_SPECIAL_PERMIT, BULLYING, COPYRIGHT_INFRINGEMENT, SUICIDE_SELF_HARM, SCAM, FALSE_INFORMATION, I_DONT_LIKE_THIS
  const reportOption = [
    {
      title: 'Spam',
      report_type: 'SPAM',
