    ...
    <section className="flex flex-col items-center justify-center px-10 py-6">
      ...
      <div className="flex flex-col gap-3 items-center justify-center py-2 w-[490px]">
        ...
        <section className="flex w-full gap-6">
          <Button
            type="button"
            className="py-2.5 w-full text-white text-sm font-bold transition-colors ease-in-out relative z-10 rounded-md duration-300  border-2 border-version2-500 flex items-center justify-center gap-2 bg-sky-base text-version2-500 hover:border-version2-300 hover:bg-sky-base/80 hover:text-version2-400 "
            onClick={() => {
              setOptionOpen(false);
            }}
          >
