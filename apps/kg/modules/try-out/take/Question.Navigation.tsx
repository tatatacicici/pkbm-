...
const QuestionNavigation = ({
  ...
  return (
    <div className="flex flex-wrap justify-center items-center gap-3 mb-4">
      ...
      <button
        className={` flex items-center justify-center bg-sky-base border-2 border-sky-base hover:opacity-80 text-white font-bold py-3 px-2 w-full sm:w-1/3 md:w-[160px] rounded transition-all`}
        onClick={() => {
