...
import { modalDeleteSuccess } from '../../../../../recoil/atoms/rencana-studi';

export const ModalDeleteSuccess = ({title}: { title: string }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center pb-4 px-4 w-[500px]">
      ...
      <Image src={'/assets/popup-reject-1.svg'} alt='image-popup' width={60} height={60}/>
      ...
      <div className="flex pt-5 gap-x-4 w-full justify-center">
          <Button
            ...
            onClick={() => setIsModalDeleteSuccessOpen(false)}
          >
            Kembali
          </Button>
        </div>
