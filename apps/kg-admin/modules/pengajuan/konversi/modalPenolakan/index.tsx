...
import { TAccRejectModal } from '../../konversi/types';
import { modalRejectOpen } from '../store';
import { toast } from 'react-toastify';

export const ModalPenolakan: FC<TAccRejectModal> = ({ isOpen, request_id }) => {
  ...
  const handleRejectConversion = () => {
    ...
    mutate(params, {
      onSuccess: () => {
        ...
        setModalRejectOpen(false);
        toast.success('Berhasil Menolak Konversi');
      },
    });
  };
  return (
              ...
              >
                <Dialog.Panel className="w-full sm:min-w-[500px] max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-center align-middle shadow-xl transition-all flex justify-center items-center flex-col">
                  ...
                  <p className="text-lg  mt-3">
                    Apakah anda ingin menolak pengajuan Konversi ini?
                  </p>
